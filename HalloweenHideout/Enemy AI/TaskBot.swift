...
class TaskBot: GKEntity, ContactNotifiableType, GKAgentDelegate{
...
//
//        case returnToPosistionOnPath(Float)
//    }
//
//    // MARK: Properties
//
...
//                mandate = .returnToPositionOnPath(Float(closestPointOnGoodPath))
//
...
//                mandate = .returnToPositionOnPath(Float(closestPointOnBadPath))
//
...
//    }
//
//    func distanceToPoint(otherPoint: Float) -> Float {
...
//        agent.position = Float(x: Float(renderComponent.node.position.x + agentOffset.x), y: Float(renderComponent.node.position.y + agentOffset.y))
//    }
//
